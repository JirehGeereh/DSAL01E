...
namespace Lesson_5
{
    public partial class Lesson_5_Activity : Form
    {
        ...
        {
            // Converting input data from textboxes as string to numeric
            ...
            */
            ...
            // Converting numeric data to string and displayed it inside the textboxes
            ...
            // Formula for total contribution and total deduction
            total_contrib = sss_contrib + pagibig_contrib + philhealth_contrib + tax_contrib;
            total_deduction = total_contrib + total_loan;

            // Converting numeric data to string and displayed it inside the textbox for Total Deduction
            total_deduc_txtbox.Text = total_deduction.ToString("n");
        ...
        {
            // Disables all textboxes that are not for input
