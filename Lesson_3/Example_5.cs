...
namespace Lesson_3
{
    public partial class Example_5 : Form
    {
        ...
        private void preview_payslip_Click(object sender, EventArgs e)
        {
            ...
            payslip_view_listbox.Items.Add(new string('-', 100));
            ...
            payslip_view_listbox.Items.Add("Faculty Savings Loan          : " + FS_loan_txtbox.Text);
        ...
        private void Example_5_Dum_Load(object sender, EventArgs e)
        {
            // Codes for disabling
